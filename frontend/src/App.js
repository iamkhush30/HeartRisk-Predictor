...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("http://localhost:5000/api/predict", {
      ...
      .catch((error) => {
        ...
        alert("Error connecting to server. Make sure Flask is running on port 5000")
      })
  }
  ...
  const getRiskDescription = (percentage) => {
    if (percentage < 20) return "Your cardiovascular health appears to be in excellent condition."
    if (percentage < 40) return "Your risk is relatively low, but regular check-ups are recommended."
    if (percentage < 60) return "Moderate risk detected. Consider lifestyle improvements."
    if (percentage < 80) return "High risk detected. Please consult a healthcare professional."
    ...
    <div className="app-container">
      <div className="container-lg">
        ...
        <div className="intro-section mb-4">
          <div className="intro-title">Welcome to Your Heart Health Companion</div>
          <div className="intro-text">
            This AI-powered tool helps you understand your cardiovascular disease risk by analyzing key health metrics.
            Get personalized insights and learn about your health indicators in simple terms.
          </div>
        </div>

        {/* Header */}
        <h1 className="main-title">Cardiovascular Disease Predictor</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="row mb-3">
              <div className="col-md-6">
                ...
                <small className="explanation">Reference: Adults typically 20-90 years</small>
              </div>
              <div className="col-md-6">
                ...
                <div className="custom-dropdown">
                  ...
                  {genderDropdownOpen && (
                    <div className="custom-dropdown-menu">
                      <div className="custom-dropdown-option" onClick={() => handleGenderSelect("Male")}>
                        Male
                      </div>
                      <div className="custom-dropdown-option" onClick={() => handleGenderSelect("Female")}>
                        Female
                      </div>
                    </div>
                  )}
            ...
            <p className="explanation">
              BMI (Body Mass Index) is calculated from your height and weight. It indicates if you're underweight,
            ...
            <div className="row mb-3">
              <div className="col-md-6">
                ...
                <p className="explanation">The top number measuring pressure when your heart beats</p>
                <div className="input-group">
                  <input
                    type="number"
                    className="form-control"
                ...
                <div className="mt-2">
                  <span className="range-box range-normal">Normal: &lt;120</span>
                  <span className="range-box range-high">High: 120-129</span>
                  <span className="range-box range-very-high">Very High: 130+</span>
                </div>
              </div>
              <div className="col-md-6">
                <label className="form-label">Diastolic BP</label>
                <p className="explanation">The bottom number measuring pressure when your heart rests</p>
                <div className="input-group">
                  <input
                    type="number"
                    className="form-control"
                ...
                <div className="mt-2">
                  ...
                  <span className="range-box range-very-high">Very High: 90+</span>
                </div>
              </div>
            </div>
            ...
            <div className="mb-3">
              ...
              <p className="explanation">Total cholesterol level - indicates heart disease risk</p>
              <div className="form-check-grid">
                <label className="form-check">
                  <input
                    ...
                    onChange={handleInputChange}
                  />
                  <span className="form-check-label">Normal (&lt;200 mg/dL)</span>
                </label>
                <label className="form-check">
                  <input
                    type="radio"
                    ...
                    onChange={handleInputChange}
                  />
                  <span className="form-check-label">Above Normal (200-239 mg/dL)</span>
                </label>
                <label className="form-check">
                  <input
                    type="radio"
            ...
            <div className="mb-3">
              ...
              <p className="explanation">Blood glucose level - indicates diabetes risk</p>
              <div className="form-check-grid">
                <label className="form-check">
                  <input
                    type="radio"
                    ...
                    onChange={handleInputChange}
                  />
                  <span className="form-check-label">Normal (&lt;100 mg/dL)</span>
                </label>
                <label className="form-check">
                  <input
                    type="radio"
                    ...
                    onChange={handleInputChange}
                  />
                  <span className="form-check-label">Above Normal (100-125 mg/dL)</span>
                </label>
                <label className="form-check">
                  <input
                    type="radio"
            ...
            {/* Lifestyle Factors */}
            <h4 className="mt-4 mb-3">Lifestyle Factors</h4>
            <div className="form-check-grid">
              <label className="form-check">
                <input
                  type="checkbox"
        ...
        {submitted &&
          results &&
          (() => {
            const riskPercent = Math.max(0, Math.min(100, Number.parseFloat(results.proba)))
            ...
            return (
              <>
                <h3 className="section-header mt-5">Assessment Results</h3>
                      <div className="results-container">
                        <div className="results-grid">
                          <div className={`assessment-card result-main ${riskCategory}`}>
                            <div className="risk-percentage">{riskPercent}%</div>
                            <div className="risk-level">
                              <span className="risk-dot"></span>
                              {getRiskLevel(riskPercent)}
                            </div>
                            <div className="risk-description">{getRiskDescription(riskPercent)}</div>
                            
                            {/* Recommendation Message */}
                            <div className="risk-recommendation mt-3">
                              {riskPercent >= 60 ? (
                                <div className="recommendation-badge warning">
                                  <strong>⚠️ Recommendation:</strong> Please consult with a healthcare professional for a comprehensive evaluation.
                                </div>
                              ) : (
                                <div className="recommendation-badge success">
                                  <strong>✓ Great news!</strong> Your risk indicators suggest a healthy cardiovascular profile.
                                </div>
                              )}
                            </div>
                          </div>
                          <div className="result-side">
                            <div className="mini-card">
                              <div className="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div className="text-white fw-semibold">{formData.ap_hi} mmHg</div>
                              </div>
                              <div
                                className="bp-meter"
                                style={{ "--risk-percent": `${toPercent(formData.ap_hi, 90, 200)}` }}
                              >
                                <div className="bp-meter-bar">
                                  <div className="bp-meter-fill"></div>
                                  <div
                                    className="bp-marker"
                                    style={{ "--marker-percent": `${toPercent(formData.ap_hi, 90, 200)}` }}
                                  ></div>
                                  <div className="bp-tick" style={{ left: `${toPercent(120, 90, 200)}%` }}></div>
                                  <div className="bp-tick" style={{ left: `${toPercent(130, 90, 200)}%` }}></div>
                                  <div className="bp-tick-label" style={{ left: `${toPercent(120, 90, 200)}%` }}>
                                    120
                                  </div>
                                  <div className="bp-tick-label" style={{ left: `${toPercent(130, 90, 200)}%` }}>
                                    130
                                  </div>
                                </div>
                            ...
                            <div className="mini-card">
                              <div
                                className="bp-meter"
                                style={{ "--risk-percent": `${toPercent(formData.ap_lo, 50, 120)}` }}
                              >
                                <div className="d-flex justify-content-between align-items-center mb-2">
                                  <span className="text-white-50">Diastolic BP</span>
                                  <span className="text-white fw-semibold">{formData.ap_lo} mmHg</span>
                                </div>
                                <div className="bp-meter-bar">
                                  <div className="bp-meter-fill"></div>
                                  <div
                                    className="bp-marker"
                                    style={{ "--marker-percent": `${toPercent(formData.ap_lo, 50, 120)}` }}
                                  ></div>
                                  <div className="bp-tick" style={{ left: `${toPercent(80, 50, 120)}%` }}></div>
                                  <div className="bp-tick" style={{ left: `${toPercent(90, 50, 120)}%` }}></div>
                                  <div className="bp-tick-label" style={{ left: `${toPercent(80, 50, 120)}%` }}>
                                    80
                                  </div>
                                  <div className="bp-tick-label" style={{ left: `${toPercent(90, 50, 120)}%` }}>
                                    90
                                  </div>
                                </div>
                                <div className="bp-labels">
                ...
                {/* BMI Section - Full Width Below Prediction */}
                <div className="bmi-section-container mt-4">
                  <h4 className="bmi-section-title">Body Mass Index (BMI)</h4>
                  <div className="bmi-full-width">
                    <div className="bp-meter" style={{ "--risk-percent": `${toPercent(results.bmi, 12, 45)}` }}>
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        <span className="text-white-50">Your BMI</span>
                        <span className="text-white fw-semibold">{results.bmi} - {results.category}</span>
                      </div>
                      <div className="bp-meter-bar">
                        <div className="bp-meter-fill"></div>
                        <div
                          className="bp-marker"
                          style={{ "--marker-percent": `${toPercent(results.bmi, 12, 45)}` }}
                        ></div>
                        <div className="bp-tick" style={{ left: `${toPercent(18.5, 12, 45)}%` }}></div>
                        <div className="bp-tick" style={{ left: `${toPercent(25, 12, 45)}%` }}></div>
                        <div className="bp-tick" style={{ left: `${toPercent(30, 12, 45)}%` }}></div>
                        <div className="bp-tick-label" style={{ left: `${toPercent(18.5, 12, 45)}%` }}>
                          18.5
                        </div>
                        <div className="bp-tick-label" style={{ left: `${toPercent(25, 12, 45)}%` }}>
                          25
                        </div>
                        <div className="bp-tick-label" style={{ left: `${toPercent(30, 12, 45)}%` }}>
                          30
                        </div>
                      </div>
                      <div className="bp-labels">
                        <span className={`bp-label-badge ${results.category === "Underweight" ? "active" : ""}`}>
                          Underweight: &lt;18.5
                        </span>
                        <span className={`bp-label-badge ${results.category === "Normal" ? "active" : ""}`}>
                          Normal: 18.5-24.9
                        </span>
                        <span className={`bp-label-badge ${results.category === "Overweight" ? "active" : ""}`}>
                          Overweight: 25-29.9
                        </span>
                        <span className={`bp-label-badge ${results.category === "Obese" ? "active" : ""}`}>
                          Obese: 30+
                        </span>
                      </div>
                    </div>
